...
- The reviewer approves when no blocking finding exists and requests changes for any `P0` or `P1` finding. Its read-only model does not post to GitHub, merge, push product code, or edit repository files; only the guarded Python parent posts the structured review.
