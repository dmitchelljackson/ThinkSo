...
2. Use the configured local Android emulator by default. Exercise the free iOS Simulator when the ticket affects portable UI and the required capability is available. Do not require paid Apple login or APNs for the demo.
...
6. Test at representative compact and large phone sizes when layout is affected. Use Google login for feasible iOS flows and real Android notification delivery where required.
